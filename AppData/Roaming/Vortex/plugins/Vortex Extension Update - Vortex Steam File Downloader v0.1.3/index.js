...
/*!********************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/index.js ***!
  \********************************************************/
...
/*!***************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/alphabet.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/build.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/decode.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/encode.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/index.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!***************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/is-valid.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*********************************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/random/random-byte-browser.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!******************************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/random/random-from-seed.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*************************************************************************************!*\
  !*** C:/Projects/vortex/node_modules/shortid/lib/util/cluster-worker-id-browser.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var http = __webpack_require__(/*! follow-redirects */ "./node_modules/follow-redirects/index.js").http,
https = __webpack_require__(/*! follow-redirects */ "./node_modules/follow-redirects/index.js").https,
urlParser = __webpack_require__(/*! url */ "url"),
util = __webpack_require__(/*! util */ "util"),
events = __webpack_require__(/*! events */ "events"),
zlib = __webpack_require__(/*! zlib */ "zlib"),
node_debug = __webpack_require__(/*! debug */ "./node_modules/node-rest-client/node_modules/debug/src/browser.js")("NRC");

exports.Client = function (options){
    var self = this,
     // parser response manager
     parserManager = __webpack_require__(/*! ./nrc-parser-manager */ "./node_modules/node-rest-client/lib/nrc-parser-manager.js")(),
     serializerManager = __webpack_require__(/*! ./nrc-serializer-manager */ "./node_modules/node-rest-client/lib/nrc-serializer-manager.js")(),
    // connection manager
...
parserManager.add(Object.assign({
	...
	"parseString":__webpack_require__(/*! xml2js */ "./node_modules/xml2js/lib/xml2js.js").parseString,
...
var xmlserializer = __webpack_require__(/*! xml2js */ "./node_modules/xml2js/lib/xml2js.js");
...
/***/ "./node_modules/node-rest-client/node_modules/debug/src/browser.js":
/*!*************************************************************************!*\
  !*** ./node_modules/node-rest-client/node_modules/debug/src/browser.js ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./common */ "./node_modules/node-rest-client/node_modules/debug/src/common.js")(exports);
...
/***/ "./node_modules/node-rest-client/node_modules/debug/src/common.js":
/*!************************************************************************!*\
  !*** ./node_modules/node-rest-client/node_modules/debug/src/common.js ***!
  \************************************************************************/
/*! no static exports found */
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(/*! ms */ "./node_modules/node-rest-client/node_modules/ms/index.js");
...
/***/ "./node_modules/node-rest-client/node_modules/ms/index.js":
/*!****************************************************************!*\
  !*** ./node_modules/node-rest-client/node_modules/ms/index.js ***!
  \****************************************************************/
/*! no static exports found */
...
const DelegateBase_1 = __importDefault(__webpack_require__(/*! ./DelegateBase */ "./src/delegates/DelegateBase.ts"));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Core = void 0;
const Context_1 = __importDefault(__webpack_require__(/*! ./Context */ "./src/delegates/Context.ts"));
const UI_1 = __importDefault(__webpack_require__(/*! ./UI */ "./src/delegates/UI.ts"));
class Core {
    constructor(api, gameId) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const Core_1 = __importDefault(__webpack_require__(/*! ./delegates/Core */ "./src/delegates/Core.ts"));
const createIPC_1 = __webpack_require__(/*! ./createIPC */ "./src/createIPC.ts");
...
const WorkshopPage_1 = __importDefault(__webpack_require__(/*! ./views/WorkshopPage */ "./src/views/WorkshopPage.tsx"));
const Scrubber_1 = __webpack_require__(/*! ./util/Scrubber */ "./src/util/Scrubber.ts");
const MismatchDialog_1 = __importDefault(__webpack_require__(/*! ./views/MismatchDialog */ "./src/views/MismatchDialog.tsx"));
...
function init(context) {
    ...
    let modScrubber;
    let _mismatches = [];
    vortex_api_1.util.installIconSet('steam', path.join(__dirname, 'icons.svg'));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ModScrubber = void 0;
const node_rest_client_1 = __importDefault(__webpack_require__(/*! node-rest-client */ "./node_modules/node-rest-client/lib/node-rest-client.js"));
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const errors_1 = __webpack_require__(/*! ../types/errors */ "./src/types/errors.ts");
const constants_1 = __webpack_require__(/*! ../constants */ "./src/constants.ts");
...
class ModScrubber {
    ...
    async scrubPage(query) {
        ...
        try {
            ...
            const allowReport = !(err instanceof errors_1.NoSteamDataException);
        ...
        const fetchImage = async () => {
            if (imgUrl !== fallbackImg) {
                ...
                try {
                    ...
                    vortex_api_1.log('debug', 'Failed to fetch image', err);
                }
            }
        };
        fetchImage();
    }, []);
    return (React.createElement("div", { className: 'mod-thumbnail-body' },
        React.createElement("img", { onClick: onClick, className: 'thumbnail-img', src: img }),
...
const React = __importStar(__webpack_require__(/*! react */ "react"));
const react_bootstrap_1 = __webpack_require__(/*! react-bootstrap */ "react-bootstrap");
const ModThumbnail_1 = __importDefault(__webpack_require__(/*! ./ModThumbnail */ "./src/views/ModThumbnail.tsx"));
const react_i18next_1 = __webpack_require__(/*! react-i18next */ "react-i18next");
const session_1 = __webpack_require__(/*! ../actions/session */ "./src/actions/session.ts");
const constants_1 = __webpack_require__(/*! ../constants */ "./src/constants.ts");
const initialState = {};
function WorkshopPage(props) {
    ...
    const onSetPage = React.useCallback((newPage) => {
        if (!modScrubber) {
            return;
        }
    ...
    const onSetCounter = React.useCallback((newCounter) => {
            ...
            React.createElement(vortex_api_1.FlexLayout, { type: 'column', className: 'mod-page' },
                React.createElement(vortex_api_1.FlexLayout.Fixed, null,
                    React.createElement(react_bootstrap_1.InputGroup, null,
                        React.createElement(vortex_api_1.FormInput, { className: 'mod-filter-input', value: currentFilterValue, placeholder: t('Search for a mod...'), onChange: applyFilter, debounceTimer: 1000, clearable: true }))),
                React.createElement(vortex_api_1.FlexLayout.Flex, null,
                    React.createElement("div", { className: 'modpicker-body' },
                        React.createElement(react_bootstrap_1.PanelGroup, { id: 'mod-panel-group' },
                            React.createElement(react_bootstrap_1.Panel.Body, null,
                                React.createElement(WorkshopModsMods, { t: t, fallbackImg: fallbackImg, mods: availableMods, onModClick: onModClick })))))))));
}
exports.default = WorkshopPage;
function WorkshopModsMods(props) {
    const { t, mods, onModClick, fallbackImg } = props;
    return (mods === null || mods === void 0 ? void 0 : mods.length) > 0
        ? (React.createElement("div", { className: 'mods-group' }, mods.map(mod => React.createElement(ModThumbnail_1.default, { t: t, key: mod.publishedfileid, mod: mod, onModClick: onModClick, fallbackImg: fallbackImg })))) : (React.createElement(RenderWait, null));
}
function RenderWait() {
...
/******/ });
//# sourceMappingURL=bundledPlugins/extension-steamkit/steamkit.js.map