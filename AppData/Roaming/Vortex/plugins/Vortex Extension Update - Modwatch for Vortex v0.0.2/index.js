...
/***/ "./node_modules/vortex-ext-common/dist/index.js":
/*!******************************************************!*\
  !*** ./node_modules/vortex-ext-common/dist/index.js ***!
  \******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var profileClient_1 = __webpack_require__(/*! ./profileClient */ "./node_modules/vortex-ext-common/dist/profileClient.js");
Object.defineProperty(exports, "ProfileClient", { enumerable: true, get: function () { return profileClient_1.ProfileClient; } });
var unreal_1 = __webpack_require__(/*! ./unreal */ "./node_modules/vortex-ext-common/dist/unreal.js");
Object.defineProperty(exports, "UnrealGameHelper", { enumerable: true, get: function () { return unreal_1.UnrealGameHelper; } });
var util_1 = __webpack_require__(/*! ./util */ "./node_modules/vortex-ext-common/dist/util.js");
Object.defineProperty(exports, "isActiveGame", { enumerable: true, get: function () { return util_1.isActiveGame; } });
Object.defineProperty(exports, "toAttributeInstructions", { enumerable: true, get: function () { return util_1.toAttributeInstructions; } });
Object.defineProperty(exports, "getCategoryName", { enumerable: true, get: function () { return util_1.getCategoryName; } });
Object.defineProperty(exports, "getModName", { enumerable: true, get: function () { return util_1.getModName; } });


/***/ }),

/***/ "./node_modules/vortex-ext-common/dist/profileClient.js":
/*!**************************************************************!*\
  !*** ./node_modules/vortex-ext-common/dist/profileClient.js ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/vortex-ext-common/dist/unreal.js":
/*!*******************************************************!*\
  !*** ./node_modules/vortex-ext-common/dist/unreal.js ***!
  \*******************************************************/
/*! no static exports found */
...
class UnrealGameHelper {
    constructor(gameId, enableFallback) {
        this.prepareforModding = (discovery, relativePath) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.installContent = (files, destinationPath, gameId, progressDelegate) => __awaiter(this, void 0, void 0, function* () {
            var _a;
...
/***/ "./node_modules/vortex-ext-common/dist/util.js":
/*!*****************************************************!*\
  !*** ./node_modules/vortex-ext-common/dist/util.js ***!
  \*****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getModName = exports.getCategoryName = exports.toAttributeInstructions = exports.isActiveGame = void 0;
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const path = __webpack_require__(/*! path */ "path");
function isActiveGame(context, gameId) {
    return vortex_api_1.selectors.activeGameId(context.api
...
function getModName(modOrPath, nameFallback) {
    ...
    if (typeof modOrPath == "string") {
        ...
        var mod = modOrPath;
        return (_a = vortex_api_1.util.getSafe(mod.attributes, ['customFileName'], vortex_api_1.util.getSafe(mod.attributes, ['modName'], vortex_api_1.util.getSafe(mod.attributes, ['logicalFileName'], vortex_api_1.util.getSafe(mod.attributes, ['name'], undefined))))) !== null && _a !== void 0 ? _a : nameFallback;
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ModWatchAction = void 0;
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const client_1 = __webpack_require__(/*! ./client */ "./src/client.ts");
const upload_1 = __webpack_require__(/*! ./upload */ "./src/upload.ts");
class ModWatchAction {
    constructor(api) {
        this.runAction = async (renderer, output) => {
            var userDetails = await upload_1.requestCredentials(this._api);
            if (userDetails == null) {
                return null;
            }
            else {
                var modList = JSON.parse(output);
                ...
                try {
                    upload_1.uploadModList(this._api, modList, userDetails, (upload) => {
                        vortex_api_1.log('info', 'upload completed', { status: upload });
                        if (upload) {
                            this._api.sendNotification({
                                type: 'success',
                                ...
                                actions: [
                                    {
                                        title: 'View', action: (dismiss) => {
                                            vortex_api_1.util.opn(`https://modwat.ch/u/${userDetails.username}`);
                                        }
                                    }
                                ]
                            });
        ...
        this._api = api;
        this._client = new client_1.ModWatchClient();
    }
    isEnabled(renderer) {
        return renderer == 'Modwat.ch';
    }
}
exports.ModWatchAction = ModWatchAction;
...
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
class ModWatchClient {
    constructor() {
        this.retryCount = 3;
        this.uploadModList = async (modList, user) => {
            ...
            try {
                var resp = await async_retry_1.default(async (bail) => {
                    try {
                        var response = await axios_1.default.post(url, body, {
                ...
                vortex_api_1.log('info', 'upload completed', { status: resp });
                return resp == 201;
            }
            catch (err) {
                throw (err);
        ...
        this.uploadRaw = async (game, user, data, enb, tag) => {
            var body = {
                game,
...
exports.ModWatchClient = ModWatchClient;
...
const vortex_ext_common_1 = __webpack_require__(/*! vortex-ext-common */ "./node_modules/vortex-ext-common/dist/index.js");
const upload_1 = __webpack_require__(/*! ./upload */ "./src/upload.ts");
function main(context) {
    context.requireExtension('Vortex Showcase');
    context.once(() => {
        if (util_1.isShowcaseReady(context.api)) {
            context.api.ext.addShowcaseAction('Publish', () => new action_1.ModWatchAction(context.api));
            context.api.ext.addShowcaseRenderer('Modwat.ch', () => new renderer_1.ModWatchRenderer());
        }
        else {
            vortex_api_1.log('warn', 'Showcase API not found! Modwatch support not installed');
        }
    });
    context.registerAction('mod-icons', 101, 'profile', {}, 'Upload to modwat.ch', () => {
        if (util_1.isSupported(context.api.getState())) {
            context.api.ext.createShowcase([], 'Modwat.ch', 'Publish');
        }
    }, () => util_1.isSupported(context.api.getState()) && util_1.isShowcaseReady(context.api));
    return true;
}
async function buildReport(api) {
    var currentGame = vortex_api_1.selectors.activeGameId(api.getState());
    var orderedPlugins = util_1.getOrderedPluginList(api.getState(), true);
    var modList = api.ext.getEnabledMods(currentGame);
    var model = {
        plugins: orderedPlugins.map(pl => pl.name),
        modlist: modList.map(m => vortex_ext_common_1.getModName(m)),
        game: currentGame
    };
    var userDetails = await upload_1.requestCredentials(api);
    if (userDetails != null) {
        upload_1.uploadModList(api, model, userDetails, (upload) => {
            vortex_api_1.log('info', 'upload completed', { status: upload });
            if (upload) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ModWatchRenderer = void 0;
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const util_1 = __webpack_require__(/*! ./util */ "./src/util.ts");
class ModWatchRenderer {
    createModel(api, mod) {
        vortex_api_1.log('debug', 'invoking test renderer: createModel', { mod: mod.id });
        var pluginList = util_1.getPluginList(api.getState());
        var matchingPlugins = Object.keys(pluginList).filter(pl => {
            var modName = vortex_api_1.util.getSafe(pluginList[pl], ['modName'], undefined);
    ...
    async createShowcase(api, model) {
        var state = api.getState();
        var currentGame = vortex_api_1.selectors.activeGameId(state);
        if (util_1.isSupported(currentGame)) {
            vortex_api_1.log('debug', 'building full plugin list');
            var orderedPlugins = util_1.getOrderedPluginList(state, true);
            var modIds = model.mods.map(m => m.meta.id);
            orderedPlugins = orderedPlugins.filter(pl => modIds.some(id => id == pl.plugin.modName) || util_1.isGamePlugin(state, pl));
            var output = {
                game: currentGame,
                plugins: orderedPlugins.map(pl => pl.name),
            ...
            vortex_api_1.log('warn', 'unsupported game!', { game: model.game });
            return Promise.reject('Unsupported game!');
        }
    }
    isEnabled(gameId) {
        return util_1.isSupported(gameId);
    }
}
exports.ModWatchRenderer = ModWatchRenderer;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.uploadModList = exports.requestCredentials = void 0;
const client_1 = __webpack_require__(/*! ./client */ "./src/client.ts");
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
async function requestCredentials(api) {
    var nexusUser = vortex_api_1.util.getSafe(api.getState().persistent, ['nexus', 'userInfo', 'name'], '');
    var result = await api.showDialog('question', 'Modwat.ch User Details', {
    ...
    if (result.action == "Cancel") {
        ...
        var userDetails = { password: result.input.password, username: result.input.username };
        return userDetails;
    }
}
exports.requestCredentials = requestCredentials;
async function uploadModList(api, modList, user, onUpload, onError, client) {
    client = client !== null && client !== void 0 ? client : new client_1.ModWatchClient();
    api.sendNotification({
        type: 'info',
        progress: 0,
        message: 'Uploading...',
    ...
    try {
        ...
        vortex_api_1.log('error', 'error while uploading to modwat.ch', { err });
...
exports.uploadModList = uploadModList;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.isKnownAuthor = exports.isInDLCGroup = exports.isGamePlugin = exports.getOrderedPluginList = exports.isShowcaseReady = exports.isSupported = exports.getPluginList = void 0;
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
function getPluginList(state) {
    return vortex_api_1.util.getSafe(state.session, ['plugins', 'pluginList'], {});
}
...
function isSupported(test) {
    ...
    if (typeof test == "string") {
        ...
        gameId = vortex_api_1.selectors.activeGameId(test);
    }
    const _supportedGames = ['skyrim', 'skyrimse', 'fallout4'];
    return _supportedGames.some(g => g == gameId);
}
exports.isSupported = isSupported;
function isShowcaseReady(api) {
    return (api.ext.createShowcase != undefined) && (api.ext.addShowcaseAction != undefined) && (api.ext.addShowcaseRenderer != undefined);
}
exports.isShowcaseReady = isShowcaseReady;
function getOrderedPluginList(state, includeNative = false) {
    var allPlugins = getPluginList(state);
    var loadOrder = vortex_api_1.util.getSafe(state, ['loadOrder'], {});
...
exports.getOrderedPluginList = getOrderedPluginList;
function isGamePlugin(state, plugin) {
...
exports.isGamePlugin = isGamePlugin;
function isInDLCGroup(state, fileName) {
    var pluginInfo = vortex_api_1.util.getSafe(state.session, ['plugins', 'pluginInfo', fileName], undefined);
    return pluginInfo && pluginInfo.group && pluginInfo.group.toLowerCase().indexOf('dlc') !== -1;
}
exports.isInDLCGroup = isInDLCGroup;
function isKnownAuthor(state, fileName) {
...
exports.isKnownAuthor = isKnownAuthor;
...
/******/ });
//# sourceMappingURL=vortex-showcase-modwatch.js.map