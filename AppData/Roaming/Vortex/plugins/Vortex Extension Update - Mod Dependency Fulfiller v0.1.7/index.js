...
module.exports = __webpack_require__(/*! ./lib/index */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\index.js");
...
var randomFromSeed = __webpack_require__(/*! ./random/random-from-seed */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\random\\random-from-seed.js");
...
var encode = __webpack_require__(/*! ./encode */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\encode.js");
var alphabet = __webpack_require__(/*! ./alphabet */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\alphabet.js");
...
var randomByte = __webpack_require__(/*! ./random/random-byte */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\random\\random-byte-browser.js");
...
var alphabet = __webpack_require__(/*! ./alphabet */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\alphabet.js");
var encode = __webpack_require__(/*! ./encode */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\encode.js");
var decode = __webpack_require__(/*! ./decode */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\decode.js");
var build = __webpack_require__(/*! ./build */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\build.js");
var isValid = __webpack_require__(/*! ./is-valid */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\is-valid.js");

// if you are using cluster or multiple servers use this to make each instance
// has a unique value for worker
// Note: I don't know if this is automatically set when using third
// party cluster solutions such as pm2.
var clusterWorkerId = __webpack_require__(/*! ./util/cluster-worker-id */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\lib\\util\\cluster-worker-id-browser.js") || 0;
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\persistent.ts":
/*!***************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\actions\persistent.ts ***!
  \***************************************************************/
...
exports.setFulfillerSubscription = (0, redux_act_1.createAction)('SET_FULFILLER_SUBSCRIPTION', (profileId, subId) => ({ profileId, subId }));
exports.clearFulfillerSubscription = (0, redux_act_1.createAction)('CLEAR_FULFILLER_SUBSCRIPTION', (profileId) => ({ profileId }));


/***/ }),

/***/ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\session.ts":
/*!************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\actions\session.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const redux_act_1 = __webpack_require__(/*! redux-act */ "redux-act");
exports.setOpenProfileSelect = (0, redux_act_1.createAction)('SET_OPEN_SELECT_USERDATA_PROFILE_DIALOG', (open) => {
    return open;
});
exports.setProfileUserData = (0, redux_act_1.createAction)('SET_USERDATA_PROFILE_DATA', (profileData) => profileData);
exports.setUserDataFilePath = (0, redux_act_1.createAction)('SET_USERDATA_FILEPATH', (filePath) => filePath);


/***/ }),

/***/ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\settings.ts":
/*!*************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\actions\settings.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const redux_act_1 = __webpack_require__(/*! redux-act */ "redux-act");
exports.setAutoFulfillDependencies = (0, redux_act_1.createAction)('SET_AUTO_FULFILL_DEPENDENCIES', (fulfill) => fulfill);
exports.setLockSub = (0, redux_act_1.createAction)('SET_DEP_FULFILLER_LOCK_SUB', (lock) => lock);
exports.setEnableDebugMode = (0, redux_act_1.createAction)('SET_DEP_FULFILLER_DEBUG', (debug) => debug);
exports.setReadNonPremiumNotif = (0, redux_act_1.createAction)('SET_READ_NON_PREMIUM_NOTIFICATION', (read) => read);
exports.addUrlSub = (0, redux_act_1.createAction)('ADD_URL_SUB', (urlSub) => urlSub);
exports.removeUrlSub = (0, redux_act_1.createAction)('REMOVE_URL_SUB', (id) => id);
exports.setUrlSub = (0, redux_act_1.createAction)('SET_URL_SUB', (id, urlSub) => ({ id, urlSub }));


/***/ }),

/***/ "e:\\WorkC\\dependency-fulfiller\\src\\common.ts":
/*!***************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\common.ts ***!
  \***************************************************/
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\downloader.ts":
/*!*******************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\downloader.ts ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const types_1 = __webpack_require__(/*! ./types */ "e:\\WorkC\\dependency-fulfiller\\src\\types.ts");
const util_1 = __webpack_require__(/*! ./util */ "e:\\WorkC\\dependency-fulfiller\\src\\util.ts");
...
function install(api, downloadInfo, downloadId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (downloadInfo.allowAutoInstall && ((_a = state.settings.automation) === null || _a === void 0 ? void 0 : _a['install']) !== true) {
            const gameId = (0, util_1.convertGameDomain)(downloadInfo.downloadIds.gameId);
            ...
            if (!mId) {
                return new Promise((resolve, reject) => {
                    api.events.emit('start-install-download', downloadId, true, (err, modId) => {
                        if (err) {
                            (0, vortex_api_1.log)('error', 'failed to install dependency', err);
...
function downloadImpl(api, downloadInfo, progress) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return api.emitAndAwait('nexus-download', (0, util_1.convertGameDomain)(downloadIds.gameId), downloadIds.modId, downloadIds.fileId, archiveName, allowAutoInstall)
            .then(() => {
            const { downloadId } = genDownloadProps(api, downloadInfo.archiveName);
            install(api, downloadInfo, downloadId);
            return Promise.resolve();
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\index.ts":
/*!**************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\index.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const session_1 = __webpack_require__(/*! ./actions/session */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\session.ts");
const settings_1 = __webpack_require__(/*! ./actions/settings */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\settings.ts");
const common_1 = __webpack_require__(/*! ./common */ "e:\\WorkC\\dependency-fulfiller\\src\\common.ts");
const downloader_1 = __webpack_require__(/*! ./downloader */ "e:\\WorkC\\dependency-fulfiller\\src\\downloader.ts");
const persistent_1 = __importDefault(__webpack_require__(/*! ./reducers/persistent */ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\persistent.ts"));
const session_2 = __importDefault(__webpack_require__(/*! ./reducers/session */ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\session.ts"));
const settings_2 = __importDefault(__webpack_require__(/*! ./reducers/settings */ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\settings.ts"));
const types_1 = __webpack_require__(/*! ./types */ "e:\\WorkC\\dependency-fulfiller\\src\\types.ts");
const util_1 = __webpack_require__(/*! ./util */ "e:\\WorkC\\dependency-fulfiller\\src\\util.ts");
const ProfileSelectionDialog_1 = __importDefault(__webpack_require__(/*! ./views/ProfileSelectionDialog */ "e:\\WorkC\\dependency-fulfiller\\src\\views\\ProfileSelectionDialog.tsx"));
const Settings_1 = __importDefault(__webpack_require__(/*! ./views/Settings */ "e:\\WorkC\\dependency-fulfiller\\src\\views\\Settings.tsx"));
...
function genFromSubscription(api) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield (0, util_1.fetchDepFromUrl)(subscription.url);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const modData of modsData) {
                ...
                const ids = (0, util_1.extractIds)(persistent.downloads.files[arcId]);
                if (ids === undefined || ((_b = persistent.downloads.files[arcId]) === null || _b === void 0 ? void 0 : _b.localPath) === undefined) {
                    if (persistent.downloads.files[arcId] !== undefined) {
                        (0, vortex_api_1.log)('warn', 'failed to extract required information', JSON.stringify(persistent.downloads.files[arcId]));
                    }
                    else {
                        (0, vortex_api_1.log)('warn', 'failed to extract required information - download archive missing', arcId);
                    }
                    continue;
                }
                const nexusDownload = {
...
function genFromUserData(api) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            api.store.dispatch((0, session_1.setUserDataFilePath)(selectedFile));
            ...
            api.store.dispatch((0, session_1.setProfileUserData)(profileData));
            api.store.dispatch((0, session_1.setOpenProfileSelect)(true));
        }
        catch (err) {
            api.showErrorNotification('Failed to generate dependencies from user data', err, { allowReport: false });
        }
            ...
            if (!_.isEqual(prevMods, currMods)) {
                ...
                const tryGenFromFilePath = (modId) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if ((mod === null || mod === void 0 ? void 0 : mod.installationPath) === undefined) {
                        (0, vortex_api_1.log)('debug', 'failed to complete dependency check - mod was removed', modId);
                        return Promise.resolve();
                    }
                    if (mod.state === 'installing') {
                        return new Promise((resolve) => (0, timers_1.setTimeout)(() => resolve(tryGenFromFilePath(modId)), 5000));
                    }
                ...
                yield Promise.all(diff.map((modId) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    (0, vortex_api_1.log)('info', 'attempting to fulfill mod dependencies', modId);
                    ...
                    if (modInstallationPath !== undefined) {
                        try {
                            yield Promise.race([
                                ...
                                new Promise((resolve) => (0, timers_1.setTimeout)(() => {
                                    (0, vortex_api_1.log)('error', 'dependency check timed out - use "Import Dependencies" '
                            ...
                            (0, vortex_api_1.log)('error', 'failed to complete dependency check', err);
                        }
                    }
                })));
            }
...
function fulfillRules(api, downloads) {
    var _a;
    const props = (0, util_1.genProps)(api);
    if (props === undefined) {
        return;
    }
    ...
    for (const download of downloads) {
        ...
        for (const rule of download.rules) {
            if (installed.includes((_a = rule.reference) === null || _a === void 0 ? void 0 : _a.id) && !hasRule(rule, mod(download.archiveName))) {
                api.store.dispatch(vortex_api_1.actions.addModRule((0, util_1.convertGameDomain)(download.downloadIds.gameId), mod(download.archiveName), rule));
            }
        }
    }
}
function fulfillDependencies(api, downloads) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const download of downloads) {
            try {
                yield (0, downloader_1.downloadImpl)(api, download, progress);
            }
            catch (err) {
                const state = api.getState();
                            ...
                            actions: [
                                {
                                    ...
                                    action: (dismiss) => api.showDialog('info', 'Not a premium member', {
                                    ...
                                    }, [
                                        {
                                            label: 'Close',
                                            action: () => {
                                                api.store.dispatch((0, settings_1.setReadNonPremiumNotif)(true));
                                                dismiss();
                                            },
                                        },
                                    ]),
                ...
                if (props !== undefined) {
                    const dwnlId = Object.keys(props.downloads).find(dlId => {
                        ...
                        const ids = (0, util_1.extractIds)(dl);
                        return (0, util_1.compareIds)(ids, download.downloadIds);
                    });
                    if (dwnlId !== undefined) {
                        yield (0, downloader_1.install)(api, download, dwnlId);
                        continue;
                    }
                }
...
function genFromFilePath(api, filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            (0, vortex_api_1.log)('error', 'failed to read/parse dependency manifest', err);
        }
        const lockedSub = vortex_api_1.util.getSafe(api.getState(), ['settings', 'interface', 'lockSub'], false);
        if (lockedSub) {
            (0, util_1.disableAllMods)(api);
            parsedDownloadInfo = parsedDownloadInfo.map(download => (Object.assign(Object.assign({}, download), { allowAutoEnable: true })));
        }
        const uniqueDownloads = Array.from(new Set(parsedDownloadInfo.map(a => (0, util_1.genIdentifier)(a.downloadIds))))
            .map(id => parsedDownloadInfo.find(a => (0, util_1.genIdentifier)(a.downloadIds) === id));
...
function genDependencyManifest(api, modIds) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        api.sendNotification({
            ...
            actions: [
                {
                    title: 'Save to file', action: () => __awaiter(this, void 0, void 0, function* () {
                        yield vortex_api_1.fs.ensureDirWritableAsync(common_1.MANIFESTS_PATH);
                        const tmpPath = path.join(common_1.MANIFESTS_PATH, `${(0, util_1.formatTime)(timestamp)}${common_1.DEP_MAN_SUFFIX}`);
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\persistent.ts":
/*!****************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\reducers\persistent.ts ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const actions = __importStar(__webpack_require__(/*! ../actions/persistent */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\persistent.ts"));
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\session.ts":
/*!*************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\reducers\session.ts ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const actions = __importStar(__webpack_require__(/*! ../actions/session */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\session.ts"));
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\reducers\\settings.ts":
/*!**************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\reducers\settings.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const actions = __importStar(__webpack_require__(/*! ../actions/settings */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\settings.ts"));
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\types.ts":
/*!**************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\types.ts ***!
  \**************************************************/
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\util.ts":
/*!*************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\util.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "e:\\WorkC\\dependency-fulfiller\\src\\views\\ProfileSelectionDialog.tsx":
/*!**************************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\views\ProfileSelectionDialog.tsx ***!
  \**************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function mapDispatchToProps(dispatch) {
    return {
        onSetOpen: (open) => dispatch((0, session_1.setOpenProfileSelect)(open)),
    };
}
...
exports["default"] = (0, react_i18next_1.withTranslation)(['common', 'dependency-fulfiller'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(ProfileSelectionDialog));


/***/ }),

/***/ "e:\\WorkC\\dependency-fulfiller\\src\\views\\Settings.tsx":
/*!************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\views\Settings.tsx ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "react-redux");
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const UrlSubscriber_1 = __importDefault(__webpack_require__(/*! ./UrlSubscriber */ "e:\\WorkC\\dependency-fulfiller\\src\\views\\UrlSubscriber.tsx"));
const settings_1 = __webpack_require__(/*! ../actions/settings */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\settings.ts");
const common_1 = __webpack_require__(/*! ../common */ "e:\\WorkC\\dependency-fulfiller\\src\\common.ts");
...
function mapDispatchToProps(dispatch) {
    return {
        onSetAutoFulfillDependencies: (fulfill) => dispatch((0, settings_1.setAutoFulfillDependencies)(fulfill)),
        onSetEnableDebugMode: (debugMode) => dispatch((0, settings_1.setEnableDebugMode)(debugMode)),
    };
}
exports["default"] = (0, react_i18next_1.withTranslation)(['common', 'dependency-fulfiller'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(Settings));


/***/ }),

/***/ "e:\\WorkC\\dependency-fulfiller\\src\\views\\UrlSubscriber.tsx":
/*!*****************************************************************!*\
  !*** e:\WorkC\dependency-fulfiller\src\views\UrlSubscriber.tsx ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "react-redux");
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const shortid_1 = __webpack_require__(/*! shortid */ "e:\\WorkC\\dependency-fulfiller\\node_modules\\shortid\\index.js");
const persistent_1 = __webpack_require__(/*! ../actions/persistent */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\persistent.ts");
const settings_1 = __webpack_require__(/*! ../actions/settings */ "e:\\WorkC\\dependency-fulfiller\\src\\actions\\settings.ts");
const common_1 = __webpack_require__(/*! ../common */ "e:\\WorkC\\dependency-fulfiller\\src\\common.ts");
    ...
    constructor(props) {
        ...
        this.subEditorDialog = (evt) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (res.action === 'Save') {
                ...
                const newSub = {
                    id: (sub === null || sub === void 0 ? void 0 : sub.id) !== undefined ? sub.id : (0, shortid_1.generate)(),
                    name,
                    url,
                };
                if (sub !== undefined) {
...
function mapStateToProps(state) {
    ...
    return {
        profile,
        subId: (profile !== undefined)
            ? vortex_api_1.util.getSafe(state, ['persistent', 'depfulfiller', profile.id, 'subId'], undefined)
            : undefined,
...
function mapDispatchToProps(dispatch) {
    return {
        onSetLock: (lock) => dispatch((0, settings_1.setLockSub)(lock)),
        onAddSub: (sub) => dispatch((0, settings_1.addUrlSub)(sub)),
        onEditSub: (id, sub) => dispatch((0, settings_1.setUrlSub)(id, sub)),
        onRemoveSub: (id) => dispatch((0, settings_1.removeUrlSub)(id)),
        onSetSubscription: (profileId, subId) => dispatch((0, persistent_1.setFulfillerSubscription)(profileId, subId)),
        onClearSubscription: (profileId) => dispatch((0, persistent_1.clearFulfillerSubscription)(profileId)),
    };
}
exports["default"] = (0, react_i18next_1.withTranslation)(['common', 'dependency-fulfiller'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(UrlSubscriber));
...
/******/ 	var __webpack_exports__ = __webpack_require__("e:\\WorkC\\dependency-fulfiller\\src\\index.ts");
/******/ 	module.exports = __webpack_exports__;
/******/ 	
/******/ })()
;
//# sourceMappingURL=dependency-fulfiller.js.map