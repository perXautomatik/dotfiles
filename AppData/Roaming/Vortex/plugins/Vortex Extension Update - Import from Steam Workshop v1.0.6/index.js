...
function importMods(t, store, wsBasePath, mods, progress) {
    ...
    return bluebird_1.default.mapSeries(mods, (mod, idx, len) => {
        ...
        return transferMod(mod, wsBasePath, installPath, vortexId)
            ...
            .catch(err => {
            (0, vortex_api_1.log)('debug', 'Failed to import', err);
        ...
        .then(() => {
        (0, vortex_api_1.log)('debug', 'Finished importing');
        return errors;
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getWorkshopModDataold = exports.getWorkshopModData = void 0;
const vortex_api_1 = __webpack_require__(/*! vortex-api */ "vortex-api");
const path = __importStar(__webpack_require__(/*! path */ "path"));
...
function getWorkshopModData(workshopPath) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const directory = yield vortex_api_1.fs.readdirAsync(workshopPath);
            ...
            workshopIds.map((id, idx) => formData.append(`publishedfileids[${idx}]`, id.toString()));
            try {
                const ax = new axios_1.Axios(axiosConfig);
                const query = yield ax.post(`/ISteamRemoteStorage/GetPublishedFileDetails/v1/?`, formData);
                if (!((_b = (_a = query.data) === null || _a === void 0 ? void 0 : _a.response) === null || _b === void 0 ? void 0 : _b.publishedfiledetails)) {
                    const err = new Error('The Steam API returned an invalid response.');
                    err.code = 'STEAMAPIERROR';
                    (0, vortex_api_1.log)('error', 'Steam API response did not contain publishedfiledetails', { status: query.status, response: query.data });
                    throw err;
                }
                const mappedData = workshopIds.map(id => { var _a, _b; return (_b = (_a = query.data) === null || _a === void 0 ? void 0 : _a.response) === null || _b === void 0 ? void 0 : _b.publishedfiledetails.find((file) => file.publishedfileid === id); });
                return mappedData;
            }
            catch (err) {
                if (err instanceof axios_1.AxiosError || err.code === 'STEAMAPIERROR') {
                    throw new axios_1.AxiosError('An unexpected error occured when requested Workshop mod details from Steam', err.code);
                }
                else
                    throw new Error('An unknown error occurred: ' + ((err === null || err === void 0 ? void 0 : err.message) || err));
            }
        }
        catch (err) {
            throw err;
...
function getWorkshopModDataold(workshopPath) {
            ...
            const req = https.request(steamRequestOptions, (res) => {
                ...
                res.on('end', () => {
                    ...
                    if (!((_a = reply.response) === null || _a === void 0 ? void 0 : _a.publishedfiledetails)) {
                        ...
                        err.code = 'STEAMAPIERROR';
                        (0, vortex_api_1.log)('error', 'Steam API response did not contain publishedfiledetails', (reply.response || reply));
                        return reject(err);
                    }
...
exports.getWorkshopModDataold = getWorkshopModDataold;
...
class ImportDialog extends vortex_api_1.ComponentEx {
    ...
    start() {
        ...
        return (0, workshopUtil_1.default)(discovered, gameId, steamAppId)
            .then(found => {
    ...
    setup() {
        ...
        return (0, workshopUtil_1.getWorkshopModData)(workshopPath)
    ...
    startImport() {
        ...
        (0, import_1.default)(t, this.context.api.store, workshopPath, enabledMods, (mod, perc) => {
