    ...
    return (react_1.default.createElement("table", null,
        react_1.default.createElement("thead", null,
            react_1.default.createElement("tr", null,
                ...
                react_1.default.createElement("th", null))),
        react_1.default.createElement("tbody", null, Object.keys(managers !== null && managers !== void 0 ? managers : {}).map(managerId => react_1.default.createElement(ManagerListItem, { t: t, key: managerId, name: managerId, exePath: managers[managerId], pipe: pipes[managerId], editing: edit === managerId, onEdit: setEdit, onChange: onSetItem, onRemove: onRemoveItem }))),
    ...
    return (react_1.default.createElement("table", null,
        react_1.default.createElement("thead", null,
            react_1.default.createElement("tr", null,
                ...
                react_1.default.createElement("th", null, t('Manager')),
                react_1.default.createElement("th", null))),
        react_1.default.createElement("tbody", null, Object.keys(games !== null && games !== void 0 ? games : {}).sort(byGameId).map(gameId => react_1.default.createElement(GameListItem, { t: t, key: gameId, game: gameId, gameOptions: gameOptions, manager: games[gameId], managers: managers, editing: edit === gameId, onEdit: setEdit, onChange: onSetItem, onRemove: onRemoveItem }))),
        react_1.default.createElement("tfoot", null,
            react_1.default.createElement("tr", null,
...
function main(context) {
    ...
    context.once(() => __awaiter(this, void 0, void 0, function* () {
        ...
        net.createServer(socket => {
            ...
            .on('error', err => {
            (0, vortex_api_1.log)('error', 'failed to open download pipe', err.message);
