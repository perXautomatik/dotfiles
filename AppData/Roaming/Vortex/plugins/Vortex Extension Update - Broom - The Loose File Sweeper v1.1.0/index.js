...
exports.setOpenBroomDialog = (0, redux_act_1.createAction)('SET_OPEN_BROOM_DIALOG', (open) => open);
exports.addBroomMessages = (0, redux_act_1.createAction)('ADD_BROOM_MESSAGES', (msgList) => msgList);
exports.clearBroomMessages = (0, redux_act_1.createAction)('CLEAR_BROOM_MESSAGES', () => { });
exports.setBroomMatchedFiles = (0, redux_act_1.createAction)('SET_BROOM_MATCHED_FILES', (pathList) => pathList);
...
const redux_act_1 = __webpack_require__(/*! redux-act */ "redux-act");
exports.setBroomDeleteFiles = (0, redux_act_1.createAction)('SET_BROOM_DELETE_FILES', (flag) => flag);
exports.setBroomUnhide = (0, redux_act_1.createAction)('SET_BROOM_UNHIDE', (flag) => flag);
...
function main(context) {
    context.registerAction("mod-icons", 500, 'plugin-light', {}, 'Broom', () => {
        context.api.store.dispatch((0, session_2.setOpenBroomDialog)(true));
    });
...
class BroomDialog extends vortex_api_1.ComponentEx {
    constructor(props) {
        ...
        this.search = () => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let mod of enabledMods) {
                ...
                yield this.findFiles(modPath, [{ inclusive: true, value: /\.broom(\.vohidden)?$/i }], null, broomFiles);
    ...
    render() {
        ...
        return (react_1.default.createElement(react_bootstrap_1.Modal, { id: 'broom-page', show: open, onEnter: this.enter, onHide: this.close, bsSize: "large", dialogClassName: "broom-modal" },
            ...
            react_1.default.createElement(react_bootstrap_1.Modal.Body, { style: styleObj }, messages.map(msg => react_1.default.createElement("div", { style: styleObj, dangerouslySetInnerHTML: { __html: msg } }))),
...
function mapDispatchToProps(dispatch) {
    return {
        onSetOpen: (open) => dispatch((0, session_1.setOpenBroomDialog)(open)),
        onAddMessages: (msgList) => dispatch((0, session_1.addBroomMessages)(msgList)),
        onClearMessages: () => dispatch((0, session_1.clearBroomMessages)([])),
        onSetMatchedFiles: (pathList) => dispatch((0, session_1.setBroomMatchedFiles)(pathList))
    };
}
...
exports["default"] = (0, react_i18next_1.withTranslation)(['common', 'broom'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(BroomDialog));
...
function mapDispatchToProps(dispatch) {
    return {
        onSetDeleteFiles: (flag) => dispatch((0, settings_1.setBroomDeleteFiles)(flag)),
        onSetUnhide: (flag) => dispatch((0, settings_1.setBroomUnhide)(flag)),
    };
}
exports["default"] = (0, react_i18next_1.withTranslation)(['common', 'broom'])((0, react_redux_1.connect)(mapStateToProps, mapDispatchToProps)(Settings));
